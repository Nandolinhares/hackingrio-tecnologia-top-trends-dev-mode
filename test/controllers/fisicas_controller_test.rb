...
class FisicasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fisica" do
    assert_difference('Fisica.count') do
      post fisicas_url, params: { fisica: { cpf: @fisica.cpf, endereco: @fisica.endereco, nome: @fisica.nome, telefone: @fisica.telefone, token: @fisica.token } }
    end
  ...
  test "should update fisica" do
    patch fisica_url(@fisica), params: { fisica: { cpf: @fisica.cpf, endereco: @fisica.endereco, nome: @fisica.nome, telefone: @fisica.telefone, token: @fisica.token } }
